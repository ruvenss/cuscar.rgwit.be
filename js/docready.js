...
var csc_bl  ="CNI+";
var csc_blrff="RFF+BM:";
var csc_agent="BEST";
var csc_dod ="DTM+342:20"; /* Date of Departure */
var csc_pol ="LOC+76+"; /* Port of loading */
var csc_pol2="LOC+80+"; /* Port of loading 2 */
var csc_pol3="LOC+9+"; /* Port of loading 3 */
var csc_pod ="LOC+11+"; /* Port of discharge */
var csc_podv="LOC+60+"; /* Port of discharge */
var csc_pot ="LOC+8+"; /* Port of transit */
...
var csc_ship="NAD+CZ++"; /* Shipper Data  */
var csc_vol = "MEA+AAE+AAW+MTQ:"; /* Volume Data  */
var csc_weight="MEA+AAE+G+KGM:"; /* Weight Data  */
var csc_packnumb="GIS+TX:110"; /* Package Number  */
var csc_packtypecode="GIS+23"; /* Package Type Code  */
var csc_packtype="GID+1+1:"; /* Packaging type  */
var csc_packmode="GID+1+1:"; /* Package mode */
var csc_goods="FTX+AAA+++"; /* Goods Desc  */
var csc_vin="SGP+"; /* VIN or CIN */
var csc_vin2="PCI+24+"; /* VIN or CIN */
var csc_eof="'\n"; /* End of Line for Cuscar BL Data */
